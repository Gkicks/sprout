...
class TestRecipeForm(TestCase):
    ...
    def test_form_is_valid(self):
        ...
        self.assertTrue(recipe_form.is_valid(), msg="recipe form is not valid")
    ...
    def test_recipe_name_empty(self):
        ...
        self.assertFalse(recipe_form.is_valid(), msg="recipe form valid with empty recipe_name")

    def test_recipe_name_too_long(self):
        """
        recipe_name more than 255 characters
        """
        recipe_form = RecipeForm ({'recipe_name': ''})
        self.assertFalse(recipe_form.is_valid(), msg="recipe form valid with 260 characters")
    ...
    def test_recipe_name_not_unique(self):
        ...
        self.assertFalse(recipe_form.is_valid(), msg="recipe form valid with duplicate recipe name")
...
class TestCommentForm(TestCase):
    ...
    def test_form_is_not_valid(self):
        ...
        self.assertFalse(comment_form.is_valid(), msg="comment form is valid with empty string")
...
class TestRatingForm(TestCase):
    ...
    def test_form_is_not_valid_empty(self):
        ...
        self.assertFalse(rating_form.is_valid(), msg="rating form is valid with empty string")
    ...
    def test_form_is_not_valid_other_int(self):
        ...
        self.assertFalse(rating_form.is_valid(), msg="rating form is valid with integer not in range 1-5")
    ...
    def test_form_is_not_valid_negative(self):
        ...
        self.assertFalse(rating_form.is_valid(), msg="rating form is valid with negative number")
    ...
    def test_form_is_not_valid_letter(self):
        ...
        self.assertFalse(rating_form.is_valid(), msg="rating form is valid with letter")
    ...
    def test_form_is_not_valid_special(self):
        ...
        """
        rating_form = RatingForm({'rating': '%'})
        self.assertFalse(rating_form.is_valid(), msg="rating form is valid with special character")